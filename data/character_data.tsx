export const stories = [
  ...
  },
  {
    ...
    name: "Lord Kurt\nO’Silas-McGee",
    story:
      "Lord Kurt O’Silas-McGee föddes in i en förmögen adlad familj. Trots sin privilegierade uppväxt spenderade han en otalig mängd timmar av sin ungdom på att studera ockulta skrifter och mystiska symboler från forna kulturer. Studerandet gick över till forskning, forskningen gick över till ett beroende...\nTack vare sin expertis och status inom riket lyckades Lord O’Silas-McGee övertyga kungafamiljen att finansiera en expedition över Atlanten för att utforska de teorier som framkommit under sin forskning.\nResan mot väst var lång och sträng, dess syfte hölls hemligt från besättningen på skeppet som blev mer och mer ivriga ju längre bort de seglade från sina hem. Slutdestinationen nåddes efter 53 dagar… Isle de Tekla, centrum av Bermudatriangeln.\nLord O’Silas-McGee var den första att sätta fot på ön. Han identifierade genast en grotta som såg bekant ut från ett manuskript han läst för många år sedan.",
  },
  {
    id: "thom",
    columns: "3",
  ...
  },
  {
    ...
    name: "Joe-Lou\nS. Vagster",
    story:
      "I en isolerad by omgiven av djupa skogar och bergskedjor föddes en mystisk flicka med övernaturliga förmågor. Joe-Lou S. Vagster var fruktad och respekterad av folket i byn. För det mesta höll hon sig för sig själv och tillbringade större delen av sin tid till att utforska sina krafter.  Enstaka gånger vågade personer söka henne för hennes råd och vägledning. En av dessa var Drottning Regina Zéralth.\nEn dag efter att ha sett en framtidssyn, där Nolle-P blev en plats där ljuset hade nått nya höjder och mörkret tappat all sin makt, kände hon att hon var tvungen att göra något åt saken. Samma dag fick hon ett bud från drottningen som kallade henne. Drottningen ville att Joe-Lou skulle ansluta till en grupp av utvalda personer som tillsammans skulle ta sig an uppdraget slå ut ljuset. Mörkret skulle härska över NolleP igen. NolleP skulle bli deras.",
  },
  {
    id: "tayla_asher",
    columns: "2",
    name: "Tayla Schans &\nAsher Sir Weiss",
    story:
      "En mörk och stormig natt lämnades en korg på slottets trappa med två tvillingar. Under deras uppväxt lärde sig Asher Sir Weiss och Tayla Schans slottets allra mörkaste hemligheter.\nHovet märkte snabbt att något var fel med de två barnen, de omgavs alltid av ett stort mörker. Vissa av tjänarna kände så stort obehag att de lämnade slottet. När tvillingarna blev äldre fick de jobb på slottet som tjänare men steg fort i rangerna och blev snart personalansvariga. Då de var mästare på viskningar tog de sakta men säkert kontroll över slottets tjänare. De som gjorde motstånd syntes aldrig mer. Drottningen hade länge haft ögonen på tvillingarna och deras mörka talanger och tänkte att de var användbara för att ta över Nolle-P.",
  },
  {
    id: "tiff",
    columns: "3",
    name: "Tiff\nHeather",
    story:
      "Tiff Heather föddes som Lady Tiffany Heather Breezor. Som yngsta dotter till den välkände och förmögne Earlen av Breezor var hon dömd till ett trist öde som fin dam, hänvisad till att sitta lugnt och lydigt i salongerna. Redan som liten hade Lady Tiffany andra idéer för sin framtid. Hon brukade smita ut för att leka i skogen eller för att pinnfäktas med tjänstefolkets barn. Sonen till husets jägmästare blev hennes bästa vän. Han lärde henne allt han kunde om jakt och hon blev till slut mycket duktigare än honom själv. Mjuk som en fjäder gled hon genom skogarna utan att föra minsta oväsen, hennes byten var aningslösa. Ryktet säger att den svarta fjädern i hennes hatt inte är en jakttrofé, utan en ledtråd om hennes sanna karaktär.\nEn morgon var Lady Tiffany försvunnen. Earl och Lady Breezor trodde deras dotter blivit bortrövad av banditer ute efter lösensumma. I själva verket hade Tiff Heather för gott gett sig av för att tjäna makten som kallat henne. För att ansluta till drottningens innersta krets av trogna anhängare som Tiff Heather, jägmästarinna och spejare. ",
  },
  {
    id: "count",
    columns: "3",
    name: "Count D \nBenjamins",
    story:
      "Count D Benjamins sägs vara den mest manipulativa och sluga bedragaren någonsin. Som liten växte han upp, trots sin adliga titel, utan rikedom och status på grund av hans fars spelberoende. För att återskapa sig en förmögenhet flyttade D och charmade in sig i det finaste huset i den nya staden. Genom att muta, förråda och utpressa rätt personer jobbade han sig snabbt upp i anseende och utnyttjade alla längs vägen till sin egen vinning.\nEfter ett speciellt brev är han nu redo att infiltrera en ny stad. Var försiktig, och håll hårt i dina hemligheter.",
  },
  {
    id: "ping",
    columns: "3",
